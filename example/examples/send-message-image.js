...
import { sendImageMessage, ConversationType } from "react-native-rongcloud-imlib";
...
export default class extends React.PureComponent {
  static route = "SendImageMessage";
  static navigationOptions = { title: "发送图片消息" };
  ...
  send = () => {
    ...
    const content = { type: "image", localUri };
    sendImageMessage(
      conversationType,
      targetId,
      content,
